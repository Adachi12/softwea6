...
int usedlog_insert_test_start() {
    ...
    USEDLOG_TABLE test_data4  = {0, 1, "2020-01-04 14:45:00", 10.0, "03:00:00", 400};
    USEDLOG_TABLE test_data5  = {0, 0, "2020-01-04 15:00:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data6  = {0, 1, "2020-01-04 16:00:00", 15.5, "04:00:00", 400};
    USEDLOG_TABLE test_data7  = {0, 1, "2020-01-05 08:00:00", 13.0, "03:30:00", 400};
    USEDLOG_TABLE test_data8  = {0, 2, "2020-01-05 09:00:00",  2.5, "00:40:00", 400};
    USEDLOG_TABLE test_data9  = {0, 0, "2020-01-05 12:45:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data10 = {0, 3, "2020-01-06 15:00:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data11 = {0, 0, "2021-01-03 13:00:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data12 = {0, 3, "2021-01-03 13:00:00",  5.0, "01:00:00", 400};
    USEDLOG_TABLE test_data13 = {0, 2, "2021-01-04 14:30:00",  2.0, "00:40:00", 400};
    USEDLOG_TABLE test_data14 = {0, 1, "2021-01-04 14:45:00", 10.0, "03:00:00", 400};
    USEDLOG_TABLE test_data15 = {0, 0, "2021-01-04 15:00:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data16 = {0, 1, "2021-01-04 16:00:00", 15.5, "04:00:00", 400};
    USEDLOG_TABLE test_data17 = {0, 1, "2021-01-05 08:00:00", 13.0, "03:30:00", 400};
    USEDLOG_TABLE test_data18 = {0, 2, "2021-01-05 09:00:00",  2.5, "00:40:00", 400};
    USEDLOG_TABLE test_data19 = {0, 0, "2021-01-05 12:45:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data20 = {0, 3, "2021-01-06 15:00:00",  4.5, "01:00:00", 400};
