...
int usedlog_insert_test_start() {
    ...
    USEDLOG_TABLE test_data7  = {0, 01571225, "2020-01-05 08:00:00", 13.0, "03:30:00", 400};
    ...
    USEDLOG_TABLE test_data14 = {0, 01571225, "2021-01-04 14:45:00", 10.0, "03:00:00", 400};
    USEDLOG_TABLE test_data15 = {0, 0, "2021-01-04 15:00:00",  4.5, "01:00:00", 400};
    USEDLOG_TABLE test_data16 = {0, 01571225, "2021-01-04 16:00:00", 15.5, "04:00:00", 400};
    USEDLOG_TABLE test_data17 = {0, 01571225, "2021-01-05 08:00:00", 13.0, "03:30:00", 400};
